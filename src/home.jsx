...
export default function WeddingInvitation() {
  const linkConfirmacion =
    "https://docs.google.com/forms/d/e/1FAIpQLSdCZkTI_0xWwi7xUd2adjbSkpNEUqAxG1m0QxV5MHTI18w_MQ/viewform?usp=publish-editor";
  const linkMapsCeremonia = "https://maps.app.goo.gl/fCuJEuU2rRWZcEAfA";
  const linkSugerirCancion =
    "https://docs.google.com/forms/d/e/1FAIpQLSdp_W_-_nkP8hmnpVNKgHfF76pI4xiiXsr24Ao9Lkyr-1VYHw/viewform?usp=publish-editor";
  const linkSpotify =
    "https://open.spotify.com/playlist/1gjH3wHWk8gXfcaExEzD7W?si=8427fcfbe7e44452";
  ...
  return (
    <div className="min-h-screen font-light selection:bg-[#bb9a2f]/30">
      ...
      >
        ...
        <div className="hero-content text-center text-white relative z-10">
          <div className="max-w-2xl">
            <h1 className="romantic-title text-7xl md:text-8xl mb-4 italic text-[#bb9a2f]">
              Loren & Angie
            </h1>
            <p className=" text-2xl tracking-[0.3em] font-light uppercase">
        ...
        <div className="max-w-md mx-auto">
          <div className="bg-white rounded-none shadow-2xl overflow-hidden flex flex-col">
            ...
            <div className="p-8 pb-12 text-center flex flex-col items-center">
              <h3 className="romantic-title text-4xl mb-6 text-[#ceb185]">
                La Celebración
              </h3>
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-16">
          ...
          <div className="flex flex-col items-center space-y-4">
            <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center shadow-md border border-[#e9dcc9]">
              ...
              >
                <path
                  d="M9 3L5 21H19L15 3H13.5L14.5 8L12 7L9.5 8L10.5 3H9Z"
                  stroke="#ceb185"
                  strokeWidth="1.2"
                  strokeLinejoin="round"
                />
                <path
                  d="M10 20L10.5 21M14 20L13.5 21"
                  stroke="#ceb185"
                  strokeWidth="1.2"
                />
                <rect
            ...
            <h4 className="uppercase tracking-[0.2em] text-[#b8860b] font-bold text-xs">
              Dress Code
            </h4>
          ...
          <div className="flex flex-col items-center space-y-4">
            <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center shadow-md border border-[#e9dcc9]">
              ...
              >
                ...
                />
                <path
                  d="M19 7C19 7 21 8 21 10C21 12 19 13 19 13"
                  stroke="#ceb185"
                  strokeWidth="1.2"
                />
                <path
                  d="M5 7V17M3 7V11C3 12.5 4 13 5 13M7 7V11C7 12.5 6 13 5 13"
                  stroke="#ceb185"
                  strokeWidth="1.2"
                  strokeLinecap="round"
                />
            ...
            <p className="text-[#666] text-sm max-w-xs">
              Si eres alérgico a algún alimento, por favor indícalo en el
      ...
      {/* SECCIÓN 4: PARALLAX */}
      <section
        className="parallax-section h-[60vh] flex items-center justify-center relative"
        style={{
          backgroundImage:
      ...
      >
        ...
        <div className="relative z-10 text-center px-4">
          <h2 className="romantic-title text-5xl md:text-7xl text-white italic drop-shadow-lg mb-4">
            ¡Nos vemos pronto!
          </h2>
        </div>
      </section>
      ...
      <section className="py-24 bg-white text-center px-6">
        <div className="max-w-xl mx-auto flex flex-col items-center">
          ...
          <h3 className="romantic-title text-4xl mb-4 text-[#7a0d1a]">
            ¿Qué canción no puede faltar?
          </h3>
          <p className="text-sm text-[#666] mb-7 max-w-md">
            Para ir calentando motores, puedes escuchar nuestra lista oficial o
            decirnos qué canción te haría perrear hasta el suelo.
          </p>
          ...
          <a
            href={linkSugerirCancion}
            target="_blank"
            rel="noreferrer"
            className="text-[#b8860b] text-xs font-bold tracking-[0.2em] uppercase border-b border-[#b8860b]/30 pb-1 hover:text-[#7a0d1a] transition-all"
          >
            Sugerir mi canción
          </a>
        </div>
      ...
      <section id="rsvp" className="py-28 bg-[#3d251e] text-center px-4">
        <h2 className="romantic-title text-6xl mb-8 text-[#bb9a2f]">
          Confirmar Asistencia
        </h2>
        <div className="max-w-md mx-auto">
          <p className="text-xl mb-4 font-light italic text-white/80">
            ¿Nos acompañas en este día?
          </p>
          <p className="text-sm text-white/50 mb-12 uppercase tracking-widest">
            Agradecemos tu confirmación lo antes posible.
          </p>
          <a
            href={linkConfirmacion}
            target="_blank"
            rel="noreferrer"
            className="btn btn-romantic px-10 md:px-20 h-16 text-lg md:scale-110"
          >
            Confirmar Aquí
          </a>
        </div>
      ...
      <footer className="py-12 bg-[#2a1a15] text-[#bb9a2f] text-center">
        ...
        <p className="text-xs uppercase tracking-[0.4em] opacity-40">
          28 de agosto de 2026 • Tetir, Fuerteventura
        </p>
      </footer>
    </div>
  );
